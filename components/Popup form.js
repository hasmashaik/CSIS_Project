...
export default function CourseEnquiryPopup({
  ...
  const [formData, setFormData] = useState({
    ...
    phone: "",
    email: "",
    enquiryFor: "", // "" | "Courses / Internship" | "IT Jobs" | "Non-IT Jobs"
    location: "",
    state: "",
    experience: "",
    branch: "",
  ...
  const handleSubmit = (e) => {
    ...
    } else if (formData.enquiryFor === "IT Jobs" || formData.enquiryFor === "Non-IT Jobs") {
    ...
    <>
      ...
      {showInlineTriggers && (
        <div className="fixed bottom-24 left-4 z-[99999] flex flex-col gap-2">
          ...
          <button onClick={() => openWith("IT Jobs")} className="bg-green-700 text-white px-3 py-2 rounded-md text-sm shadow hover:bg-green-600">
            IT / Non-IT Jobs
          </button>
        </div>
      )}
      ...
      {!isControlled && showImage && !isOpen && (
        <div onClick={() => setOpen(true)} className="fixed bottom-32 right-6 z-[99999] flex items-center justify-center cursor-pointer">
          <img src="/Popup images/Floatable Form Icon.png" alt="Enquiry Button Mobile" className="w-10 h-10 object-contain drop-shadow-xl block md:hidden" />
          <img src="/Popup images/Floatable Form Icon.png" alt="Enquiry Button Desktop" className="w-12 h-12 object-contain drop-shadow-xl hidden md:block" />
        </div>
      )}
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                  ...
                  <div>
                    <select name="enquiryFor" required value={formData.enquiryFor} onChange={handleChange} className="w-full bg-white text-black rounded-md py-2 px-3 text-sm outline-none">
                      ...
                      <option value="Non-IT Jobs">Non-IT Jobs</option>
                    </select>
                  ...
                  ) : formData.enquiryFor === "IT Jobs" || formData.enquiryFor === "Non-IT Jobs" ? (
                    <>
