...
//     title: "Job Seeker",
//     options: [
//       { label: "🖥️ IT Jobs", key: "it_jobs", form: true, team: "HR Team" },
//       { label: "🛠️ Non-IT Jobs", key: "nonit_jobs", form: true, team: "HR Team" },
//     ],
//   },
...
//       // Also save to localStorage for admin panel immediate access
//       try {
...
//       <input name="trainingCourse" placeholder="Course Interested" className="border p-2 rounded-md text-sm" onChange={update} disabled={loading} />
